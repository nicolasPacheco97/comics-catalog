...
function CardCharacterName({item, visible}: Props) {
    ...
    <div className="w-full relative">
        ...
        <span className="text-white font-marvel text-5xl md:text-[5rem] uppercase block text-center w-full" >{item?.name}</span>
    </div>
</article>
}

export default CardCharacterName